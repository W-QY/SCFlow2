...
def parse_args():
    ...
    parser.add_argument('--config', 
                        # default='configs/flow_refine/pfc_raft_flow_mask.py', 
                        # default='configs/flow_refine/scflow.py',
                        default='configs/flow_refine/dgflow.py',
                        # default='configs/flow_refine/dgflow_rm_fusion.py',
                        # default='work_dirs/dgflow_unseen/GSOBJAPE_ycbv_iter8_bs16_lr1e-4Cos_r10d100_200k_train1009/dgflow.py',
    ...
    parser.add_argument('--resume-from', 
                        # default='work_dirs/dgflow_unseen/GSOBJAPE_ycbv_iter8_bs16_lr1e-4Cos_r10d100_200k_train1009/latest.pth',
                        type=str)
...
def build_dataloader(cfg, dataset, dataset_cfg, distributed, shuffle):
    if dataset_cfg.get('multisourcesample', None) is not None:
        ...
        dataloader = DataLoader(
            ...
            collate_fn=partial(collate, samples_per_gpu=cfg.data.samples_per_gpu),
            shuffle=False,
            persistent_workers=True,    # seen: False unseen: True
            # pin_memory=False,  # CUDA acceleration
