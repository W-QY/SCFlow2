...
if __name__ == '__main__':
    ...
    for dataset_name in datasets_all:
        # dataset_name = 'ycbv'       # lmo tless tudl icbin itodd hb ycbv
        methods_name = 'genflow-mh'  # foundpose genflow megapose
        ...
        seg_annots_init_root = f'data/reference_masks/01_converted_mask_all/cnos_fastsam_all/{dataset_name}'
        seg_annots_save_root = f'data/reference_masks/cnos_per_method/{methods_name}/{dataset_name}'
        ...
        for img_path in tqdm(image_files):
            ...
            for i in range(ref_obj_num):
                ...
                for j in range(len(mask_bboxes)):
                    if ref_pose_annots[i]['score'] == mask_annots[j]['score']:
                        mask_index = j
