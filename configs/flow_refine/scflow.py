...
# _base_ = '../refine_datasets/ycbv_mixpbr.py'
# _base_ = '../refine_datasets/lmo_mixpbr_depth.py'
...
num_class = 30  # lmo: 15, tudl: 3, icbin: 2, tless: 30, itodd: 28, hb: 33, ycbv: 21
...
model = dict(
    ...
    decoder=dict(
        type='SCFlowDecoder',   # SCFlowDecoder DGFlowDecoder
        net_type='Basic',
        num_levels=4,
        radius=4,
        iters=8,
        ...
        pose_head_cfg=dict(
            ...
            num_class=num_class,
            in_channels=224,        # default = 224 + 64         64  288
            net_type='Basic',
    ...
    pose_loss_cfg=dict(
        ...
        gamma=0.8,
        loss_func_cfg=dict(
            type='DisentanglePointMatchingLoss',    # DisentanglePointMatchingLoss     
    ...
    init_cfg=dict(
        ...
        # checkpoint='work_dirs/scflow/ycbv_real_100k_pointnet_Sam6dDeltaPose_bs8_train0511/iter_70000.pth'
    )
)
...
log_config=dict(interval=50, # 100
                hooks=[
                    dict(type='TextLoggerHook'),
                    dict(type='TensorboardImgLoggerHook', interval=100, image_format='HWC')])

work_dir = 'work_dirs/scflow/ycbv_real_debug'
# work_dir = 'work_dirs/scflow/ycbv_real_100k_dgflowencoder_order1024_pointfeats_train0419'
# load_from = 'work_dirs/scflow/ycbv_real_100k_pointnet_Sam6dDeltaPose_bs8_train0511/iter_70000.pth'
# work_dir = 'work_dirs/scflow/ycbv_real_100k_pointnet_Sam6dDeltaPose_bs8_train0511'

# work_dir = 'work_dirs/scflow/ycbv_mixpbr_100k_pointnet_Sam6dDeltaPose_bs8_pose+samloss_train0510'
# work_dir = 'work_dirs/scflow/ycbv_mixpbr_100k_dgflowencoder_order1024_pointfeats_train0418'
# work_dir = 'work_dirs/scflow/ycbv_mixpbr_100k_train0403'
