...
class TransformerBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.self_attn = FeatureTransformerLayer(d_model=d_model,
                                          nhead=nhead,
        ...
        self.cross_attn_ffn = FeatureTransformerLayer(d_model=d_model,
                                               nhead=nhead,
                                               attention_type=attention_type,
                                               ffn_dim_expansion=ffn_dim_expansion,
                                               with_shift=with_shift,
...
class GeometricStructureEmbedding(nn.Module):
    def __init__(self, hidden_dim=64, sigma_d=0.2, sigma_a=15, angle_k=3, reduction_a='max'):
